...
class ClassLoader
{
    ...
    public function add ($prefix, $paths, $prepend = false)
    {
        if (! $prefix) {
            if ($prepend) {
                $this->fallbackDirsPsr0 = array_merge((array) $paths, 
                        $this->fallbackDirsPsr0);
            } else {
                $this->fallbackDirsPsr0 = array_merge($this->fallbackDirsPsr0, 
                        (array) $paths);
            }
        ...
        if ($prepend) {
            $this->prefixesPsr0[$first][$prefix] = array_merge((array) $paths, 
    ...
    public function addPsr4 ($prefix, $paths, $prepend = false)
    {
        if (! $prefix) {
            ...
            if ($prepend) {
                $this->fallbackDirsPsr4 = array_merge((array) $paths, 
                        $this->fallbackDirsPsr4);
            } else {
                $this->fallbackDirsPsr4 = array_merge($this->fallbackDirsPsr4, 
                        (array) $paths);
            }
            ...
            $this->prefixDirsPsr4[$prefix] = array_merge((array) $paths, 
    ...
    private function findFileWithExtension ($class, $ext)
    {
        ...
        if (false !== $pos = strrpos($class, '\\')) {
            ...
            $logicalPathPsr0 = substr($logicalPathPsr4, 0, $pos + 1) . strtr(
                    substr($logicalPathPsr4, $pos + 1), '_', DIRECTORY_SEPARATOR);
        } else {
