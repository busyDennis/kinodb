...
class Navigation extends AbstractNavigationHelper
{
     ...
     * @throws \Zend\View\Exception\ExceptionInterface if proxying to a helper,
     *         and the
    ...
    {
        return $this->findHelper($this->getDefaultProxy())
            ->render($container);
    }
     ...
     * @throws Exception\RuntimeException if $strict is true and helper cannot
     *         be found
