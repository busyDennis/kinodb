...
abstract class AbstractHelper extends View\Helper\AbstractHtmlElement implements 
        EventManagerAwareInterface, HelperInterface, 
        ServiceLocatorAwareInterface, TranslatorAwareInterface
{
    ...
    /**
     * Verifies container and eventually fetches it from service locator if it
     * is a string
     *
    ...
    protected function parseContainer (&$container = null)
    {
        ...
        if (is_string($container)) {
             ...
             *
             * The navigation container is probably located in
             * Zend\ServiceManager\ServiceManager
             * and not in the View\HelperPluginManager. If the set service
             * locator is a
             * HelperPluginManager, access the navigation container via the main
             * service locator.
             */
    ...
    public function htmlify (AbstractPage $page)
    {
        ...
        return '<a' . $this->htmlAttribs($attribs) . '>' . $escaper($label) .
                 '</a>';
    }
    ...
    protected function normalizeId ($value)
    {
        ...
        $prefix = strtolower(
                trim(substr($prefix, strrpos($prefix, '\\')), '\\'));
     ...
     *            instance of type {@link Acl\Role\RoleInterface}, or null.
     *            Default
            ...
            throw new Exception\InvalidArgumentException(
                    sprintf(
                            '$role must be a string, null, or an instance of ' .
                                    ...
                                    (is_object($role) ? get_class($role) : gettype(
                                            $role))));
        }
     ...
     *            instance of {@link Acl\Role\RoleInterface}. Default is null,
     *            which
    ...
    protected function setDefaultListeners ()
    {
        ...
        $this->getEventManager()
            ->getSharedManager()
            ->attach('Zend\View\Helper\Navigation\AbstractHelper', 'isAllowed', 
                array(
