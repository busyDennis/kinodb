...
class HelperPluginManager extends AbstractPluginManager
{
    ...
    protected $invokableClasses = array(
            // basepath, doctype, and url are set up as factories in the
            // ViewHelperManagerFactory.
            // basepath and url are not very useful without their factories,
            // however the doctype
            // helper works fine as an invokable. The factory for doctype simply
            // checks for the
            // config value from the merged config.
            'doctype' => 'Zend\View\Helper\Doctype', // overridden
                                                     // by a factory
                                                     // in
                                                     // ViewHelperManagerFactory
