...
class ClassGenerator extends AbstractGenerator
{
    ...
    public static function fromReflection (ClassReflection $classReflection)
    {
        ...
        foreach ($classReflection->getProperties() as $reflectionProperty) {
            if ($reflectionProperty->getDeclaringClass()->getName() ==
                ...
                $properties[] = PropertyGenerator::fromReflection(
                        $reflectionProperty);
            }
        }
     ...
     * @configkey flags int Flags, one of ClassGenerator::FLAG_ABSTRACT
        ...
        foreach ($array as $name => $value) {
            ...
            switch (strtolower(
                ...
                case 'namespacename':
                    ...
                    break;
                case 'docblock':
                    $docBlock = ($value instanceof DocBlockGenerator) ? $value : DocBlockGenerator::fromArray(
                            $value);
     ...
     */
    public function __construct ($name = null, $namespaceName = null, $flags = null, 
            $extends = null, $interfaces = array(), $properties = array(), $methods = array(), 
            $docBlock = null)
    {
        if ($name !== null) {
            $this->setName($name);
    ...
    {
        return (($isAbstract) ? $this->addFlag(self::FLAG_ABSTRACT) : $this->removeFlag(
                self::FLAG_ABSTRACT));
    }
    ...
    {
        return (($isFinal) ? $this->addFlag(self::FLAG_FINAL) : $this->removeFlag(
                self::FLAG_FINAL));
    }
            ...
            $flags = PropertyGenerator::FLAG_PUBLIC)
    {
        ...
        return $this->addPropertyFromGenerator(
                new PropertyGenerator($name, $defaultValue, $flags));
    }
     ...
     * @return ClassGenerator
     */
    public function addMethod ($name = null, array $parameters = array(), 
            $flags = MethodGenerator::FLAG_PUBLIC, $body = null, $docBlock = null)
    {
        if (! is_string($name)) {
            throw new Exception\InvalidArgumentException(
                    sprintf('%s expects string for name', __METHOD__));
        ...
        return $this->addMethodFromGenerator(
                new MethodGenerator($name, $parameters, $flags, $body, $docBlock));
    }
    ...
    public function addMethodFromGenerator (MethodGenerator $method)
    {
        ...
        if (isset($this->methods[$methodName])) {
            throw new Exception\InvalidArgumentException(
                    sprintf('A method by name %s already exists in this class.', 
                            $methodName));
        }
