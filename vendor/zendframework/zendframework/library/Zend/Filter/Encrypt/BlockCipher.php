...
class BlockCipher implements EncryptionAlgorithmInterface
{
    ...
    {
        try {
            $this->blockCipher = CryptBlockCipher::factory('mcrypt', 
                    $this->encryption);
        } catch (SymmetricException\RuntimeException $e) {
            throw new Exception\RuntimeException(
                    'The BlockCipher cannot be used without the Mcrypt extension');
        }
    ...
    public function setEncryption ($options)
    {
        ...
        if (isset($options['hash'])) {
            try {
                ...
                throw new Exception\InvalidArgumentException(
                        "The algorithm '{$options['hash']}' is not supported");
            }
        }
