...
class Json
{
            ...
            $objectDecodeType = self::TYPE_OBJECT)
    {
        ...
        if (function_exists('json_decode') &&
                 static::$useBuiltinEncoderDecoder !== true) {
            ...
            $options = array())
    {
        if (is_object($valueToEncode)) {
            if (method_exists($valueToEncode, 'toJson')) {
                ...
                return static::encode($valueToEncode->toArray(), $cycleCheck, 
                        $options);
            }
        }
        ...
        if (isset($options['enableJsonExprFinder']) &&
            ...
            $valueToEncode = static::_recursiveJsonExprFinder($valueToEncode, 
        ...
        if (function_exists('json_encode') &&
            ...
            $encodedResult = Encoder::encode($valueToEncode, $cycleCheck, 
                    $options);
        }
            ...
            array &$javascriptExpressions, $currentKey = null)
    {
        if ($value instanceof Expr) {
            ...
            $javascriptExpressions[] = array(
                    ...
                    // required.
                    "magicKey" => (is_int($currentKey)) ? $magicKey : Encoder::encodeUnicodeString(
                            $magicKey),
            ...
            foreach ($value as $k => $v) {
                $value[$k] = static::_recursiveJsonExprFinder($value[$k], 
            ...
            $ignoreXmlAttributes, $recursionDepth = 0)
    {
        ...
        foreach ($children as $child) {
            ...
            $element = static::_processXml($child, $ignoreXmlAttributes, 
                    $recursionDepth + 1);
     ...
     * converts that PHP array into JSON by calling the "encode" static
     * function.
     *
            ...
            $ignoreXmlAttributes = true)
    {
        ...
        $resultArray = static::_processXml($simpleXmlElementObject, 
                $ignoreXmlAttributes);
