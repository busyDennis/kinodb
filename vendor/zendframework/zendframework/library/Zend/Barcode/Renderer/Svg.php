...
class Svg extends AbstractRenderer
{
    ...
    protected function initRenderer ()
    {
        ...
        if ($this->resource === null) {
            ...
            $this->rootElement->setAttribute('xmlns', 
            ...
            $this->appendRootElement('title', array(), 
                    "Barcode " . strtoupper($this->barcode->getType()) . " " .
     ...
     */
    protected function appendRootElement ($tagName, $attributes = array(), 
            $textContent = null)
    {
     ...
     * @return DOMElement
     */
    protected function createElement ($tagName, $attributes = array(), 
            $textContent = null)
    {
