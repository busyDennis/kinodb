...
class Code25interleaved extends Code25
{
    ...
    protected function calculateBarcodeWidth ()
    {
        ...
        $characterLength = (3 * $this->barThinWidth + 2 * $this->barThickWidth) *
                 $this->factor;
        $encodedData = strlen($this->getText()) * $characterLength;
        $stopCharacter = ($this->barThickWidth + 2 * $this->barThinWidth) *
                 $this->factor;
    ...
    protected function prepareBarcode ()
    {
        ...
        // Encoded $text
        $text = $this->getText();
        for ($i = 0, $len = strlen($text); $i < $len; $i += 2) { // Draw 2 chars
                                                                 // at a time
