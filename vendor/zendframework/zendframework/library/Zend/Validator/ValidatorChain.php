...
class ValidatorChain implements Countable, ValidatorInterface
{
     ...
     *            Options to pass to validator constructor (if not already
     *            instantiated)
     ...
     * @return ValidatorChain
     */
    public function prependByName ($name, $options = array(), 
            $breakChainOnFailure = false)
    {
        $validator = $this->plugin($name, $options);
    ...
    public function isValid ($value, $context = null)
    {
        ...
        foreach ($this->validators as $element) {
            ...
            $this->messages = array_replace_recursive($this->messages, 
                    $messages);
