...
class Ip extends AbstractValidator
{
    ...
    // Enable IPs in literal format (only IPv6 and
    // IPvFuture)
    ...
    public function setOptions ($options = array())
    {
        ...
        if (! $this->options['allowipv4'] && ! $this->options['allowipv6'] &&
                 ! $this->options['allowipvfuture']) {
    ...
    public function isValid ($value)
    {
        ...
        if ($this->options['allowipv4'] && $this->validateIPv4($value)) {
            ...
            if (($this->options['allowipv6'] && $this->validateIPv6($value)) || ($this->options['allowipvfuture'] &&
    ...
    protected function validateIPv6 ($value)
    {
        ...
        if (strpos($value, '.')) {
            ...
            if (! ($lastcolon &&
                     $this->validateIPv4(substr($value, $lastcolon + 1)))) {
                return false;
            }
