...
class Chain implements StorageInterface
{
    ...
    /**
     * Loop over the queue of storage until a storage is found that is
     * non-empty.
     * If such
     ...
     * non-empty. Report
     * that, but also make sure that all storage with higher priorty that are
     * empty
     * are filled.
     *
    ...
    public function isEmpty ()
    {
        ...
        // Loop invariant: $storageWithHigherPriority contains all storage with
        // higher priorty
