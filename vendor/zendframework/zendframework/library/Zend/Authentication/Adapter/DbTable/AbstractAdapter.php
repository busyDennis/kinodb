...
abstract class AbstractAdapter extends BaseAdapter
{
     ...
     *            Optional
     */
    public function __construct (DbAdapter $zendDb, $tableName = null, 
    ...
    public function authenticate ()
    {
        ...
        if (($authResult = $this->authenticateValidateResultSet(
                $resultIdentities)) instanceof AuthenticationResult) {
            return $authResult;
        }
        
        // At this point, ambiguity is already done. Loop, check and break on
        // success.
    ...
    {
        return new AuthenticationResult($this->authenticateResultInfo['code'], 
