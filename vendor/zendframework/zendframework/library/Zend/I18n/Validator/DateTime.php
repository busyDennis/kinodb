...
class DateTime extends AbstractValidator
{
    ...
    public function isValid ($value)
    {
        ...
        if (intl_is_failure($formatter->getErrorCode())) {
            throw new ValidatorException\InvalidArgumentException(
    ...
    protected function getIntlDateFormatter ()
    {
        if ($this->formatter == null || $this->invalidateFormatter) {
            $this->formatter = new IntlDateFormatter($this->getLocale(), 
                    $this->getDateType(), $this->getTimeType(), 
                    $this->getTimezone(), $this->getCalendar(), 
                    $this->getPattern());
