...
class Decode
{
    ...
    public static function splitMime ($body, $boundary)
    {
        ...
        // it safe to assume noone needs \r?
            ...
            $EOL = Mime::LINEEND)
    {
        ...
        $result = array();
        $headers = null; // "Declare" variable before the first usage "for
                         // reading"
        $body = null; // "Declare" variable before the first usage "for
                      // reading"
            ...
            $EOL = Mime::LINEEND, $strict = false)
    {
        ...
        if (! preg_match('%^[^\s]+[^:]*:%', $firstline)) {
            ...
            // and is it safe to assume noone needs \r?
            $body = str_replace(
                    array(
                            "\r",
                            "\n"
        ...
        // see @ZF2-372, pops the first line off a message if it doesn't contain
        // a header
        if (! $strict) {
