 ...
 * Zend\XmlRpc\Value::getXmlRpcValue, this
...
abstract class AbstractValue
{
    ...
    public static function setGenerator (
            Generator\GeneratorInterface $generator = null)
    {
     ...
     * 2. By specifying the native type ($type is one of the
     * Value::XMLRPC_TYPE_* constants)
            ...
            case self::XMLRPC_TYPE_STRUCT:
                ...
                foreach ($value->member as $member) {
                    ...
                    if (! isset($member->value) or ! isset($member->name)) {
                        continue;
                        // throw new Value_Exception('Member of the '.
                        // self::XMLRPC_TYPE_STRUCT .' XML-RPC native type must
                        // contain a VALUE tag');
                    }
                    $values[(string) $member->name] = static::_xmlStringToNativeXmlRpc(
                            $member->value);
                }
