...
abstract class AbstractFunction
{
     ...
     */
    public function __construct (ReflectionFunctionAbstract $r, 
            $namespace = null, $argv = array())
    {
        $this->reflection = $r;
     ...
     * @return array
     */
    protected function buildSignatures ($return, $returnDesc, $paramTypes, 
            $paramDesc)
    {
        $this->return = $return;
        ...
        foreach ($signatures as $signature) {
            $return = new ReflectionReturnValue(array_shift($signature), 
                    $this->returnDesc);
            $tmp = array();
            foreach ($signature as $key => $type) {
                $param = new ReflectionParameter($params[$key], $type, 
    ...
    protected function reflect ()
    {
        ...
        $scanner = new DocBlockReflection(
    ...
    public function __wakeup ()
    {
        if ($this->reflection instanceof PhpReflectionMethod) {
            ...
            $this->reflection = new PhpReflectionMethod($class->newInstance(), 
                    $this->getName());
        } else {
