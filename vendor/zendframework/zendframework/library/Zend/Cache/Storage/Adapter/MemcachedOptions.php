...
class MemcachedOptions extends AdapterOptions
{
     ...
     */
    public function setMemcachedResource (
            MemcachedResource $memcachedResource = null)
    {
        trigger_error(
    ...
    public function setResourceManager (
            MemcachedResourceManager $resourceManager = null)
    {
    ...
    public function setPersistentId ($persistentId)
    {
        ...
        $this->getResourceManager()->setPersistentId($this->getPersistentId(), 
                $persistentId);
        return $this;
    }
    ...
    {
        $this->getResourceManager()->setServers($this->getResourceId(), 
                $servers);
        return $this;
    }
    ...
    public function setLibOption ($key, $value)
    {
        ...
        $this->getResourceManager()->setLibOption($this->getResourceId(), $key, 
                $value);
        return $this;
    }
    ...
    public function getLibOption ($key)
    {
        ...
        return $this->getResourceManager()->getLibOption($this->getResourceId(), 
                $key);
    }
}
