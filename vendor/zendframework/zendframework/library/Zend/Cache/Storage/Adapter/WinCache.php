...
class WinCache extends AbstractAdapter implements AvailableSpaceCapableInterface, 
        FlushableInterface, TotalSpaceCapableInterface
{
    ...
    public function __construct ($options = null)
    {
        if (! extension_loaded('wincache')) {
            throw new Exception\ExtensionNotLoadedException(
                    "WinCache extension is not loaded");
        }
    ...
    protected function internalSetItems (array & $normalizedKeyValuePairs)
    {
        ...
        $namespace = $options->getNamespace();
        if ($namespace === '') {
            return wincache_ucache_set($normalizedKeyValuePairs, null, 
                    $options->getTtl());
        }
        ...
        $result = wincache_ucache_set($internalKeyValuePairs, null, 
                $options->getTtl());
    ...
    protected function internalAddItems (array & $normalizedKeyValuePairs)
    {
        ...
        $namespace = $options->getNamespace();
        if ($namespace === '') {
            return wincache_ucache_add($normalizedKeyValuePairs, null, 
                    $options->getTtl());
        }
        ...
        $result = wincache_ucache_add($internalKeyValuePairs, null, 
                $options->getTtl());
    ...
    protected function normalizeMetadata (array & $metadata)
    {
        ...
        unset($metadata['key_name'], $metadata['hitcount'], 
                $metadata['ttl_seconds'], $metadata['value_size']);
    }
}
