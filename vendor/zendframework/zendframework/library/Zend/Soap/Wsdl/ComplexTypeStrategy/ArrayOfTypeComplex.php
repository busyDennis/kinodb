...
class ArrayOfTypeComplex extends DefaultComplexType
{
    ...
    protected function _addArrayOfComplexType ($singularType, $type)
    {
        ...
        $xsdComplexTypeName = 'ArrayOf' .
                 $this->getContext()->translateType($singularType);
        ...
        $complexContent = $dom->createElementNS(Wsdl::XSD_NS_URI, 
                'complexContent');
        ...
        $xsdAttribute->setAttributeNS(Wsdl::WSDL_NS_URI, 'arrayType', 
