...
class Server implements ZendServerServer
{
    ...
    public function setTypemap ($typeMap)
    {
        if (! is_array($typeMap)) {
            throw new Exception\InvalidArgumentException(
                    'Typemap must be an array');
        }
        
        foreach ($typeMap as $type) {
            if (! is_callable($type['from_xml'])) {
                throw new Exception\InvalidArgumentException(
                        'Invalid from_xml callback for type: ' .
                                 $type['type_name']);
            }
     ...
     * @return self
     * @throws Exception\InvalidArgumentException if called more than once, or
    ...
    public function setClass ($class, $namespace = '', $argv = null)
    {
        ...
        if (! is_string($class)) {
            throw new Exception\InvalidArgumentException(
                    sprintf('Invalid class argument (%s)', gettype($class)));
        }
    ...
    public function setObject ($object)
    {
        if (! is_object($object)) {
            throw new Exception\InvalidArgumentException(
                    sprintf('Invalid object argument (%s)', gettype($object)));
        }
     ...
     *
     * Uses {@link $wsdl} and return value of {@link getOptions()} to
     * instantiate
