...
use DateTimeZone;
trigger_error(
        'DateTime extension deprecated as of ZF 2.1.4; use the \DateTime constructor to parse extended ISO8601 dates instead', 
        E_USER_DEPRECATED);
...
class DateTime extends \DateTime
{
     ...
     * @return mixed
     */
    public static function createFromISO8601 ($time, 
