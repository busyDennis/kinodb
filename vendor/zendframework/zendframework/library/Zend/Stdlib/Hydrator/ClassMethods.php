...
class ClassMethods extends AbstractHydrator implements HydratorOptionsInterface
{
    ...
    public function __construct ($underscoreSeparatedKeys = true)
    {
        ...
        $this->filterComposite->addFilter("parameter", 
                new OptionalParametersFilter(), FilterComposite::CONDITION_AND);
    }
    ...
    public function setOptions ($options)
    {
        ...
        if (isset($options['underscoreSeparatedKeys'])) {
            $this->setUnderscoreSeparatedKeys(
                    $options['underscoreSeparatedKeys']);
        }
    ...
    public function extract ($object)
    {
        ...
        foreach ($methods as $method) {
            ...
            if (! $this->callableMethodFilter->filter(
            ...
            if ($this->underscoreSeparatedKeys) {
                $attribute = preg_replace_callback('/([A-Z])/', $transform, 
                        $attribute);
            }
    ...
    public function hydrate (array $data, $object)
    {
        ...
        foreach ($data as $property => $value) {
            ...
            if ($this->underscoreSeparatedKeys) {
                $method = preg_replace_callback('/(_[a-z])/', $transform, 
                        $method);
            }
            if (is_callable(
                    array(
