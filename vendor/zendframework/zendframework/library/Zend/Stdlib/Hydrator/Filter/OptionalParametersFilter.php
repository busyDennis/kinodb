...
class OptionalParametersFilter implements FilterInterface
{
     ...
     * by {@see
     * \Zend\Stdlib\Hydrator\Filter\OptionalParametersFilter::filter()},
    ...
    public function filter ($property)
    {
        ...
        try {
            ...
            throw new InvalidArgumentException(
                    sprintf('Method %s doesn\'t exist', $property));
        }
        
        $mandatoryParameters = array_filter($reflectionMethod->getParameters(), 
