        ...
        ArrayAccess, Serializable, Countable
{
     ...
     */
    public function __construct ($input = array(), $flags = self::STD_PROP_LIST, 
    ...
    public function __isset ($key)
    {
        ...
        if (in_array($key, $this->protectedProperties)) {
            throw new Exception\InvalidArgumentException(
                    '$key is a protected property, use a different key');
        }
    ...
    public function exchangeArray ($data)
    {
        ...
        if (is_object($data) &&
                 ($data instanceof self || $data instanceof \ArrayObject)) {
    ...
    public function setIteratorClass ($class)
    {
        ...
        throw new Exception\InvalidArgumentException(
                'The iterator class does not exist');
    }
