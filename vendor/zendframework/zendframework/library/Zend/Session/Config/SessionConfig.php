...
class SessionConfig extends StandardConfig
{
     ...
     */
    protected $rememberMeSeconds = 1209600;
    // 2 weeks
    ...
    {
        if (! is_numeric($hashBitsPerCharacter) || ! in_array(
                $hashBitsPerCharacter, $this->validHashBitsPerCharacters)) {
            throw new Exception\InvalidArgumentException(
    ...
    protected function getHashFunctions ()
    {
        if (empty($this->validHashFunctions)) {
             ...
             *       "0" and "1" refer to MD5-128 and SHA1-160, respectively,
             *       and are
