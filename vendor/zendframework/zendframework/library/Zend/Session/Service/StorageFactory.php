...
class StorageFactory implements FactoryInterface
{
     ...
     *
     * Uses "session_storage" section of configuration to seed a
     * StorageInterface
     * instance. That array should contain the key "type", specifying the
     * storage
     * type to use, and optionally "options", containing any options to be used
     * in
