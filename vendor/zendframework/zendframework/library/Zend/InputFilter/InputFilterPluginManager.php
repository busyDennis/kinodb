...
class InputFilterPluginManager extends AbstractPluginManager
{
    ...
    /**
     * Inject this and populate the factory with filter chain and validator
     * chain
     *
     * @param
     *            $inputfilter
    ...
    public function validatePlugin ($plugin)
    {
        if ($plugin instanceof InputFilterInterface) {
            // Hook to perform various initialization, when the inputfilter is
            // not created through the factory
