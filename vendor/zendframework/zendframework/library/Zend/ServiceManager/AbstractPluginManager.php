 ...
 */
abstract class AbstractPluginManager extends ServiceManager implements 
        ServiceLocatorAwareInterface
{
    ...
    {
        // Allow specifying a class name directly; registers as an invokable
        // class
    ...
    protected function createFromInvokable ($canonicalName, $requestedName)
    {
        ...
        if (null === $this->creationOptions || (is_array($this->creationOptions) &&
    ...
    protected function createFromFactory ($canonicalName, $requestedName)
    {
        ...
        $hasCreationOptions = ! (null === $this->creationOptions || (is_array(
                $this->creationOptions) && empty($this->creationOptions)));
    ...
    protected function createServiceViaCallback ($callable, $cName, $rName)
    {
        if (is_object($callable)) {
            ...
            // reset both rewinds and returns the value of the first array
            // element
