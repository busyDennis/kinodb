...
class DiInstanceManagerProxy extends DiInstanceManager
{
     ...
     */
    public function __construct (DiInstanceManager $diInstanceManager, 
    ...
    {
        return ($this->serviceLocator->has($classOrAlias) ||
                 $this->diInstanceManager->hasSharedInstance($classOrAlias));
    }
