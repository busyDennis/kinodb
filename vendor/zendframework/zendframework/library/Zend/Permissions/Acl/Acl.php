...
class Acl implements AclInterface
{
        ...
        foreach ($this->rules['byResourceId'] as $resourceIdCurrent => $visitor) {
            if (array_key_exists('byRoleId', $visitor)) {
                foreach ($visitor['byRoleId'] as $roleIdCurrent => $rules) {
                    if ($roleId === $roleIdCurrent) {
                        unset(
                                $this->rules['byResourceId'][$resourceIdCurrent]['byRoleId'][$roleIdCurrent]);
                    }
                }
            }
        }
    ...
    public function addResource ($resource, $parent = null)
    {
        ...
        if (null !== $parent) {
            try {
                ...
                throw new Exception\InvalidArgumentException(
                        sprintf('Parent Resource id "%s" does not exist', 
                                $resourceParentId), 0, $e);
            }
    ...
    public function removeResource ($resource)
    {
        ...
        if (null !== ($resourceParent = $this->resources[$resourceId]['parent'])) {
            unset(
                    $this->resources[$resourceParent->getResourceId()]['children'][$resourceId]);
        }
            ...
            $privileges = null, Assertion\AssertionInterface $assert = null)
    {
        ...
        if (self::TYPE_ALLOW !== $type && self::TYPE_DENY !== $type) {
            throw new Exception\InvalidArgumentException(
                    sprintf(
                            ...
                            self::TYPE_ALLOW, self::TYPE_DENY));
        }
        ...
        if (! is_array($resources)) {
            if (null === $resources && count($this->resources) > 0) {
                ...
                // Passing a null resource; make sure "global" permission is
                // also set!
    ...
    public function isAllowed ($role = null, $resource = null, $privilege = null)
    {
        ...
        if (null === $privilege) {
            ...
            do {
                ...
                // pseudo-parent
                if (null !== $role && null !== ($result = $this->roleDFSAllPrivileges(
                ...
                if (null !== ($rules = $this->getRules($resource, null))) {
                    foreach ($rules['byPrivilegeId'] as $privilege => $rule) {
                        if (self::TYPE_DENY === ($ruleTypeOnePrivilege = $this->getRuleType(
            ...
            do {
                // depth-first search on $role if it is not 'allRoles'
                // pseudo-parent
                if (null !== $role && null !== ($result = $this->roleDFSOnePrivilege(
                        $role, $resource, $privilege))) {
                    return $result;
                }
                
                // look for rule on 'allRoles' pseudo-parent
                if (null !== ($ruleType = $this->getRuleType($resource, null, 
                        $privilege))) {
     ...
     * @return bool|null
     */
    protected function roleDFSAllPrivileges (Role\RoleInterface $role, 
            Resource\ResourceInterface $resource = null)
    {
        ...
        if (null !== ($result = $this->roleDFSVisitAllPrivileges($role, 
                $resource, $dfs))) {
            return $result;
        }
     ...
     */
    protected function roleDFSVisitAllPrivileges (Role\RoleInterface $role, 
            Resource\ResourceInterface $resource = null, &$dfs = null)
    {
        if (null === $dfs) {
     ...
     * @throws Exception\RuntimeException
     */
    protected function roleDFSOnePrivilege (Role\RoleInterface $role, 
            Resource\ResourceInterface $resource = null, $privilege = null)
    {
        if (null === $privilege) {
            throw new Exception\RuntimeException(
        ...
        if (null !== ($result = $this->roleDFSVisitOnePrivilege($role, 
     ...
     * @throws Exception\RuntimeException
     */
    protected function roleDFSVisitOnePrivilege (Role\RoleInterface $role, 
            Resource\ResourceInterface $resource = null, $privilege = null, &$dfs = null)
    {
        if (null === $privilege) {
            /**
             *
        ...
        if (null !== ($ruleTypeOnePrivilege = $this->getRuleType($resource, 
                $role, $privilege))) {
     ...
     * @return string|null
     */
    protected function getRuleType (Resource\ResourceInterface $resource = null, 
            Role\RoleInterface $role = null, $privilege = null)
    {
     ...
     * @return array|null
     */
    protected function &getRules (Resource\ResourceInterface $resource = null, 
            Role\RoleInterface $role = null, $create = false)
    {
