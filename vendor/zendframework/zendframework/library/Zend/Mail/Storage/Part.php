...
class Part implements RecursiveIterator, Part\PartInterface
{
    ...
    public function __construct (array $params)
    {
        if (isset($params['handler'])) {
            ...
            if (! isset($params['id'])) {
                throw new Exception\InvalidArgumentException(
                        'need a message id with a handler');
            }
        ...
        if (isset($params['raw'])) {
            Mime\Decode::splitMessage($params['raw'], $this->headers, 
                    $this->content, Mime\Mime::LINEEND, $params['strict']);
            ...
            if (is_array($params['headers'])) {
                ...
                if (empty($params['noToplines'])) {
                    Mime\Decode::splitMessage($params['headers'], 
                            $this->headers, $this->topLines);
                } else {
     ...
     * is set to string implode is used to concat the values (with Mime::LINEEND
     * as delim).
     *
     * @param string $name
                ...
                if ($header instanceof HeaderInterface) {
                    ...
                    foreach ($header as $h) {
                        $return .= $h->getFieldValue(
                                HeaderInterface::FORMAT_RAW) . Mime\Mime::LINEEND;
                    }
    ...
    {
        return Mime\Decode::splitHeaderField(
