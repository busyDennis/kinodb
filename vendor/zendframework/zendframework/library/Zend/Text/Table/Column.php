...
class Column
{
    ...
    public function setContent ($content, $charset = null)
    {
        ...
        if ($inputCharset !== $outputCharset) {
            if (PHP_OS !== 'AIX') {
                ...
                $strWrapper = StringUtils::getWrapper($inputCharset, 
                        $outputCharset);
     ...
     *
     * @param int $colSpan            
     * @throws Exception\InvalidArgumentException When $colSpan is smaller than
     *         1
     * @return Column
     */
     ...
     * @throws Exception\InvalidArgumentException When $columnWidth is lower
     *         than 1
