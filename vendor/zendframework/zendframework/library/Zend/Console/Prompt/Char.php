...
class Char extends AbstractPrompt
{
     ...
     *            If true, case will be ignored and prompt will always return
     *            lower-cased response
     * @param bool $allowEmpty
     *            Is empty response allowed?
     * @param bool $echo
     *            Display the selection after user presses key
     */
    public function __construct ($promptText = 'Please hit a key', 
            $allowedChars = '0123456789abcdefghijklmnopqrstuvwxyz', $ignoreCase = true, $allowEmpty = false, $echo = true)
    {
    ...
    public function show ()
    {
        ...
        if ($this->echo) {
            ...
            if ($this->promptText) {
                echo "\n"; // skip to next line but only if we had any prompt
                               // text
            }
        }
