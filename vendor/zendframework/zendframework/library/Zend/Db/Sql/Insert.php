...
class Insert extends AbstractSql implements SqlInterface, PreparableSqlInterface
{
    ...
    public function values (array $values, $flag = self::VALUES_SET)
    {
        if ($values == null) {
            throw new \InvalidArgumentException(
                    'values() expects an array of values');
        }
            ...
            StatementContainerInterface $statementContainer)
    {
        ...
        foreach ($this->columns as $cIndex => $column) {
            ...
            if (isset($this->values[$cIndex]) &&
                     $this->values[$cIndex] instanceof Expression) {
                $exprData = $this->processExpression($this->values[$cIndex], 
                        $platform, $driver);
                ...
                if (isset($this->values[$cIndex])) {
                    $parameterContainer->offsetSet($column, 
                            $this->values[$cIndex]);
                } else {
        ...
        $sql = sprintf($this->specifications[self::SPECIFICATION_INSERT], 
    ...
    public function getSqlString (PlatformInterface $adapterPlatform = null)
    {
        ...
        return sprintf($this->specifications[self::SPECIFICATION_INSERT], 
