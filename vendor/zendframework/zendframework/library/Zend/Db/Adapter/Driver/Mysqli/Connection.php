...
class Connection implements ConnectionInterface, Profiler\ProfilerAwareInterface
{
    ...
    public function connect ()
    {
        ...
        $this->resource->real_connect($hostname, $username, $password, 
                $database, $port, $socket);
        
        if ($this->resource->connect_error) {
            throw new Exception\RuntimeException('Connection error', null, 
                    new Exception\ErrorException($this->resource->connect_error, 
    ...
    public function execute ($sql)
    {
        ...
        // if the returnValue is something other than a mysqli_result, bypass
        // wrapping it
