...
class Oci8 implements DriverInterface, Profiler\ProfilerAwareInterface
{
            ...
            array $options = array())
    {
        ...
        $options = array_intersect_key(array_merge($this->options, $options), 
                $this->options);
    ...
    public function registerConnection (Connection $connection)
    {
        ...
        $this->connection->setDriver($this); // needs access to driver to
                                             // createStatement()
        return $this;
    }
    ...
    public function createStatement ($sqlOrResource = null)
    {
        ...
        if (is_resource($sqlOrResource) &&
                 get_resource_type($sqlOrResource) == 'oci8 statement') {
            ...
            if (is_string($sqlOrResource)) {
                ...
                throw new Exception\InvalidArgumentException(
                        'Oci8 only accepts an SQL string or a oci8 resource in ' .
                                 __FUNCTION__);
            }
    ...
    public function createResult ($resource, $isBuffered = null)
    {
        ...
        $result->initialize($resource, 
                $this->connection->getLastGeneratedValue(), $isBuffered);
        return $result;
    }
