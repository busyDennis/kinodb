...
class EventFeature extends AbstractFeature implements EventsCapableInterface
{
     ...
     * @return void
     */
    public function postSelect (StatementInterface $statement, 
            ResultInterface $result, ResultSetInterface $resultSet)
    {
        $this->event->setName(__FUNCTION__);
        $this->event->setParams(
                array(
     ...
     * @return void
     */
    public function postInsert (StatementInterface $statement, 
     ...
     * @return void
     */
    public function postUpdate (StatementInterface $statement, 
            ResultInterface $result)
    {
        $this->event->setName(__FUNCTION__);
        $this->event->setParams(
     ...
     * @return void
     */
    public function postDelete (StatementInterface $statement, 
            ResultInterface $result)
    {
        $this->event->setName(__FUNCTION__);
        $this->event->setParams(
