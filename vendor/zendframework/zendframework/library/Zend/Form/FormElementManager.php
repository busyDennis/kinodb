...
class FormElementManager extends AbstractPluginManager
{
    ...
    /**
     * Inject the factory to any element that implements
    ...
    public function injectFactory ($element)
    {
        if ($element instanceof FormFactoryAwareInterface) {
            ...
            if ($this->serviceLocator instanceof ServiceLocatorInterface &&
                ...
                $factory->getInputFilterFactory()->setInputFilterManager(
                        $inputFilters);
            }
        }
    }
    ...
    {
        // Hook to perform various initialization, when the element is not
