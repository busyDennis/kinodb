...
class DateTimeSelect extends DateSelect
{
     ...
     * - minute_attributes: HTML attributes to be rendered with the minute
     * element
     * - second_attributes: HTML attributes to be rendered with the second
     * element
                ...
                'filters' => array(
                        array(
                                ...
                                'options' => array(
                                        ...
                                        {
                                            // Convert the date to a specific
                                            // format
                                            if (is_array($date)) {
