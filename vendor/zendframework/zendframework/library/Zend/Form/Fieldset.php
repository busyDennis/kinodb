...
class Fieldset extends Element implements FieldsetInterface
{
    ...
    public function get ($elementOrFieldset)
    {
        if (! $this->has($elementOrFieldset)) {
            throw new Exception\InvalidElementException(
                    sprintf("No element by the name of [%s] found in form", 
                            $elementOrFieldset));
        }
        ...
        if (! is_array($messages) && ! $messages instanceof Traversable) {
            throw new Exception\InvalidArgumentException(
                    sprintf(
                            ...
                            __METHOD__, 
                            (is_object($messages) ? get_class($messages) : gettype(
                                    $messages))));
        }
    ...
    public function getMessages ($elementName = null)
    {
        ...
        if (! $this->has($elementName)) {
            throw new Exception\InvalidArgumentException(
                    sprintf('Invalid element name "%s" provided to %s', 
                            $elementName, __METHOD__));
        }
    ...
    public function setObject ($object)
    {
        if (! is_object($object)) {
            throw new Exception\InvalidArgumentException(
                    sprintf('%s expects an object argument; received "%s"', 
                            __METHOD__, $object));
        }
    ...
    public function __clone ()
    {
        ...
        // Also make a deep copy of the object in case it's used within a
        // collection
        if (is_object($this->object)) {
