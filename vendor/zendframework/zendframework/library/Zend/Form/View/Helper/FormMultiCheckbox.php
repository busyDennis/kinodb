...
class FormMultiCheckbox extends FormInput
{
    ...
    public function render (ElementInterface $element)
    {
        ...
        $useHiddenElement = method_exists($element, 'useHiddenElement') &&
                 $element->useHiddenElement() ? $element->useHiddenElement() : $this->useHiddenElement;
        
        if ($useHiddenElement) {
            $rendered = $this->renderHiddenElement($element, $attributes) .
                     $rendered;
        }
            ...
            array $options, array $selectedOptions, array $attributes)
    {
        ...
        foreach ($options as $key => $optionSpec) {
            ...
            $disabled = isset($inputAttributes['disabled']) &&
                     $inputAttributes['disabled'] != false ? true : false;
            ...
            if (isset($optionSpec['label_attributes'])) {
                $labelAttributes = (isset($labelAttributes)) ? array_merge(
                        $labelAttributes, $optionSpec['label_attributes']) : $optionSpec['label_attributes'];
            }
            ...
            array $attributes)
    {
        ...
        return sprintf('<input type="hidden" %s%s', 
