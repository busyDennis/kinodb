...
class FormCollection extends AbstractHelper
{
    ...
    public function render (ElementInterface $element)
    {
        ...
        // If $templateMarkup is not empty, use it for simplify adding new
    ...
    public function renderTemplate (CollectionElement $collection)
    {
        ...
        return sprintf('<span data-template="%s"></span>', 
    ...
    protected function getElementHelper ()
    {
        ...
        if (method_exists($this->view, 'plugin')) {
            $this->elementHelper = $this->view->plugin(
                    $this->getDefaultElementHelper());
        }
        
        if (! $this->elementHelper instanceof BaseAbstractHelper) {
            // @todo Ideally the helper should implement an interface.
            throw new RuntimeException(
                    'Invalid element helper set in FormCollection. The helper must be an instance of AbstractHelper.');
        }
