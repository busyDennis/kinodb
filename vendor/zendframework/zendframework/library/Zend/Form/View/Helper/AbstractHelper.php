...
abstract class AbstractHelper extends BaseAbstractHelper
{
    ...
    public function createAttributesString (array $attributes)
    {
        ...
        foreach ($attributes as $key => $value) {
            ...
            if (! $value && isset($this->booleanAttributes[$key])) {
                // Skip boolean attributes that expect empty string as false
                // value
            ...
            // @TODO Escape event attributes like AbstractHtmlElement view
            // helper does in htmlAttribs ??
    ...
    protected function prepareAttributes (array $attributes)
    {
        foreach ($attributes as $key => $value) {
            ...
            if (isset($this->booleanAttributes[$attribute])) {
                $attributes[$attribute] = $this->prepareBooleanAttributeValue(
                        $attribute, $value);
            }
        }
    ...
    {
        if (! is_bool($value) &&
                 in_array($value, $this->booleanAttributes[$attribute])) {
            return $value;
        }
