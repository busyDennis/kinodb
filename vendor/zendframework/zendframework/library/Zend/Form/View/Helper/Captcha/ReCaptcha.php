...
class ReCaptcha extends FormInput
{
    ...
    public function render (ElementInterface $element)
    {
        ...
        $hidden = $this->renderHiddenInput($challengeName, $challengeId, 
                $responseName, $responseId);
     ...
     * @return string
     */
    protected function renderHiddenInput ($challengeName, $challengeId, 
            $responseName, $responseId)
    {
    ...
    /**
     * Create the JS events used to bind the challenge and response values to
     * the submitted form.
     *
     * @param string $challengeId            
     * @param string $responseId            
