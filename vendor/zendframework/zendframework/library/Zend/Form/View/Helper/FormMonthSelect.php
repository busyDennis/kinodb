...
class FormMonthSelect extends AbstractHelper
{
    ...
    public function render (ElementInterface $element)
    {
        ...
        // The pattern always contains "day" part and the first separator, so we
        // have to remove it
        unset($pattern['day']);
        unset($pattern[0]);
     ...
     * NOTE: we don't use a pattern for years, as years written as two digits
     * can lead to hard to
