...
class Dn implements \ArrayAccess
{
    ...
    public function get ($index, $length = 1, $caseFold = null)
    {
        ...
        return static::caseFoldDn(
                array_slice($this->dn, $index, $length, false), $caseFold);
    }
    ...
    {
        $this->caseFold = static::sanitizeCaseFold($caseFold, 
                static::$defaultCaseFold);
    }
    ...
    {
        static::$defaultCaseFold = static::sanitizeCaseFold($caseFold, 
     ...
     * are preceded by ba backslash. Control characters with an ASCII code < 32
     ...
     *            An optional array to receive DN values
     * @param string $caseFold            
     * @return bool True if the DN was successfully parsed or false if the
