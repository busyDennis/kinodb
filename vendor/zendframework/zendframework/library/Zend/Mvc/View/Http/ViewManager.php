...
class ViewManager extends AbstractListenerAggregate
{
    ...
    public function onBootstrap ($event)
    {
        ...
        $this->config = isset($config['view_manager']) &&
                 ...
                 $config['view_manager'] instanceof ArrayAccess) ? $config['view_manager'] : array();
        ...
        $events->attach(MvcEvent::EVENT_RENDER_ERROR, 
                array(
                        $injectViewModelListener,
                        'injectViewModel'
                ), - 100);
    ...
    public function getRenderer ()
    {
        ...
        $this->services->setAlias('Zend\View\Renderer\PhpRenderer', 
                'ViewRenderer');
        $this->services->setAlias('Zend\View\Renderer\RendererInterface', 
                'ViewRenderer');
    ...
    public function getRendererStrategy ()
    {
        ...
        $this->services->setService('ViewPhpRendererStrategy', 
                $this->rendererStrategy);
        $this->services->setAlias('Zend\View\Strategy\PhpRendererStrategy', 
    ...
    public function getMvcRenderingStrategy ()
    {
        ...
        $this->mvcRenderingStrategy = new DefaultRenderingStrategy(
                $this->getView());
        $this->mvcRenderingStrategy->setLayoutTemplate(
                $this->getLayoutTemplate());
        
        $this->services->setService('DefaultRenderingStrategy', 
                $this->mvcRenderingStrategy);
        $this->services->setAlias('Zend\Mvc\View\DefaultRenderingStrategy', 
                'DefaultRenderingStrategy');
        $this->services->setAlias('Zend\Mvc\View\Http\DefaultRenderingStrategy', 
                'DefaultRenderingStrategy');
    ...
    public function getExceptionStrategy ()
    {
        ...
        $this->services->setService('ExceptionStrategy', 
                $this->exceptionStrategy);
        $this->services->setAlias('Zend\Mvc\View\ExceptionStrategy', 
                'ExceptionStrategy');
        $this->services->setAlias('Zend\Mvc\View\Http\ExceptionStrategy', 
                'ExceptionStrategy');
    ...
    public function getRouteNotFoundStrategy ()
    {
        ...
        $this->routeNotFoundStrategy->setDisplayNotFoundReason(
                $displayNotFoundReason);
        $this->routeNotFoundStrategy->setNotFoundTemplate($notFoundTemplate);
        
        $this->services->setService('RouteNotFoundStrategy', 
                $this->routeNotFoundStrategy);
        $this->services->setAlias('Zend\Mvc\View\RouteNotFoundStrategy', 
                'RouteNotFoundStrategy');
        $this->services->setAlias('Zend\Mvc\View\Http\RouteNotFoundStrategy', 
                'RouteNotFoundStrategy');
     ...
     *
     * If there is a "mvc_strategies" key of the view manager configuration,
     * loop
     ...
     */
    protected function registerMvcRenderingStrategies (
