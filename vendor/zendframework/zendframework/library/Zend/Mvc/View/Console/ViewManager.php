...
class ViewManager extends BaseViewManager
{
    ...
    public function getExceptionStrategy ()
    {
        ...
        if (isset($this->config['exception_message'])) {
            $this->exceptionStrategy->setMessage(
                    $this->config['exception_message']);
        }
        ...
        $this->services->setAlias('Zend\Mvc\View\ExceptionStrategy', 
                'ExceptionStrategy');
        $this->services->setAlias('Zend\Mvc\View\Console\ExceptionStrategy', 
                'ExceptionStrategy');
    ...
    public function getRouteNotFoundStrategy ()
    {
        ...
        $this->services->setAlias('Zend\Mvc\View\Console\RouteNotFoundStrategy', 
                'RouteNotFoundStrategy');
