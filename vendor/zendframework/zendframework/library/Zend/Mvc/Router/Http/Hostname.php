...
class Hostname implements RouteInterface
{
    ...
    protected function parseRouteDefinition ($def)
    {
        ...
        while ($currentPos < $length) {
            preg_match('(\G(?P<literal>[a-z0-9-.]*)(?P<token>[:{\[\]]|$))', 
            ...
            switch ($part[0]) {
                ...
                case 'parameter':
                    ...
                    if (! isset($mergedParams[$part[1]])) {
                        ...
                        return '';
                    } elseif (! $isOptional || ! isset(
                            $this->defaults[$part[1]]) || $this->defaults[$part[1]] !==
                             $mergedParams[$part[1]]) {
                        $skip = false;
                    }
                ...
                case 'optional':
                    $skippable = true;
                    $optionalPart = $this->buildHost($part[1], $mergedParams, 
                            true);
    ...
    public function assemble (array $params = array(), array $options = array())
    {
        ...
        if (isset($options['uri'])) {
            $host = $this->buildHost($this->parts, 
