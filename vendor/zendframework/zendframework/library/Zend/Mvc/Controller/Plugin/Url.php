...
class Url extends AbstractPlugin
{
     ...
     *            RouteInterface-specific options to use in url generation, if
     *            any.
     *            If boolean, and no fourth argument, used as
     *            $reuseMatchedParams.
     ...
     * @return string
     */
    public function fromRoute ($route = null, $params = array(), $options = array(), 
        ...
        if ($route === null) {
            if (! $matches) {
                throw new Exception\RuntimeException(
                        'No RouteMatch instance present');
            }
