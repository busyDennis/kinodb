...
abstract class AbstractAdapter implements TranslatorAwareInterface
{
     ...
     */
    // abstract public function addFile($file, $validator = null, $filter =
    // null);
     ...
     * @throws Exception Not implemented
     */
    // abstract public function addType($type, $validator = null, $filter =
    // null);
     ...
     * @return AbstractAdapter
     */
    public function setValidatorManager (
                        ...
                        switch (true) {
                            ...
                            default:
                                $this->addValidator($validator, 
                                        $breakChainOnFailure, $options, $file);
                                break;
                        }
                    }
                }
    ...
    public function isValid ($files = null)
    {
        ...
        foreach ($check as $content) {
            if (array_key_exists('validators', $content) && in_array(
                    'Zend\Validator\File\Count', $content['validators'])) {
        ...
        foreach ($check as $key => $content) {
            ...
            if (array_key_exists('validators', $content)) {
                foreach ($content['validators'] as $class) {
                    ...
                    if (! empty($content['options']['ignoreNoFile']) &&
