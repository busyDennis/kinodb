requirejs.config({
	...
	paths : {
		...
		jquery2 : 'jquery-2.2.4',
		//jquery3 : 'jquery-3.2.1',
		...
		// app modules
		movieModelFactory : '../js/movie.model.factory',
		commentModelFactory : '../js/comment.model.factory'
	...
	shim : {
		...
		// app modules
		'movieModelFactory' : [ 'backbone' ],
		'commentModelFactory' : [ 'backbone' ]
	}
});

// app logic
requirejs(
		[ 'backbone', 'bootstrap', 'jquery2', 'raty', 'moment', 'prefixfree',
				'underscore', 'movieModelFactory', 'commentModelFactory' ],
		function(Backbone, bootstrap, $, raty, moment, prefixfree, _,
				movieModelFactory, commentModelFactory) {
			$(document)
					.ready(
							function() {
								var Movie = movieModelFactory.getNewMovie();
								var Comment = commentModelFactory
										.getNewComment();
								...
								var MovieList = Backbone.Collection
										.extend({
											...
											descendingComparator : function(a,
													b) {
												return this
														.ascendingComparator(b,
																a);
											},

											setAscendingComparator : function(
													ascending) {
												if (ascending)
											...
											setKeyAndSort : function(key) {
												this
														.emphasizeSortingPreference(key);
												this.sortKey = key;
												this.sort();
											},
											...
											/**
											 * The new sorting preference in the
											 * dropdown menu is emphasized in
											 * bold, and the old ones are
											 * deemphasized
											 */
								...
								var MovieView = Backbone.View
										.extend({
											...
											render : function(flag) {
												...
												console
														.log("Movie attributes:"); // temporary
												console
														.log(this.model.attributes); // temporary
								...
								var CommentListView = Backbone.View
										.extend({
											...
											submitComment : function() {
												...
												this.submitKinoRating(
														collection.imdbID,
														rating);
											},

											submitKinoRating : function(imdbID,
													rating) {
												$
														.ajax({
