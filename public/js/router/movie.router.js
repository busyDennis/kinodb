define(
		[ 'jquery', 'backbone', 'movie', 'movieList', 'movieView',
				'movieListView', 'movieSearchView' ],
		function($, Backbone, Movie, MovieList, MovieView, MovieListView,
				MovieSearchView) {
			...
			var MovieRouter = Backbone.Router
					.extend({
						...
						initialize : function() {
							...
							this.route("movie/:imdbID", "imdbID", this.load_single_movie);
						},
						...
						load_single_movie : function(imdbID) {
							...
							// logging
							console
									.log("Inside \'load_single_movie\' handler; \'imdbID\' value: "
											+ imdbID);
							...
							var movieModel = new Movie({ imdbID: imdbID }, {
